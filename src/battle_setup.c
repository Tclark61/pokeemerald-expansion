...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JAMES] = REMATCH(TRAINER_ZACH_1, TRAINER_ZACH_2, TRAINER_JAMES_3, TRAINER_JAMES_4, TRAINER_JAMES_5, PETALBURG_WOODS),
    ...
    [REMATCH_WALLACE] = REMATCH(TRAINER_TYLER, TRAINER_TYLER, TRAINER_TYLER, TRAINER_TYLER, TRAINER_TYLER, EVER_GRANDE_CITY),
};
