...
const u16 gMetatiles_gTileset_InvertedIce[] = INCBIN_U16("data/tilesets/primary/inverted_ice/metatiles.bin");
const u16 gMetatileAttributes_gTileset_InvertedIce[] = INCBIN_U16("data/tilesets/primary/inverted_ice/metatile_attributes.bin");
