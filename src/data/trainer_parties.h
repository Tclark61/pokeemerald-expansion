...
static const struct TrainerMon sParty_Zander[] = {
    ...
    .moves = {MOVE_SUCKER_PUNCH, MOVE_BULK_UP, MOVE_BULLET_PUNCH, MOVE_DRAIN_PUNCH},
    ...
    .moves = {MOVE_KNOCK_OFF, MOVE_BULK_UP, MOVE_REVERSAL, MOVE_FAKE_OUT},
    .heldItem = ITEM_BLACK_BELT
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    ...
    .moves = {MOVE_MACH_PUNCH, MOVE_SPORE, MOVE_SWORDS_DANCE, MOVE_SEED_BOMB},
    .heldItem = ITEM_BLACK_BELT
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    ...
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_SWORDS_DANCE, MOVE_LEAF_BLADE, MOVE_BRICK_BREAK},
    .heldItem = ITEM_BLACK_BELT
    }
};
...
static const struct TrainerMon sParty_Cindy1[] = {
    ...
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_CONFUSION, MOVE_HELPING_HAND},
    }
};
...
static const struct TrainerMon sParty_Dominik[] = {
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_DISCHARGE, MOVE_CONFUSE_RAY, MOVE_BUBBLE_BEAM}
    },
    {
    .lvl = 26,
    .species = SPECIES_OCTILLERY,
    .moves = {MOVE_OCTAZOOKA, MOVE_PSYBEAM, MOVE_FOCUS_ENERGY, MOVE_SIGNAL_BEAM}
    },
    {
    .lvl = 24,
    .species = SPECIES_DUCKLETT,
    .moves = {MOVE_AIR_SLASH, MOVE_FEATHER_DANCE, MOVE_AQUA_JET, MOVE_SCALD}
    }
};
...
static const struct TrainerMon sParty_Drew[] = {
    ...
    .moves = {MOVE_DISABLE, MOVE_SUBSTITUTE, MOVE_OCTAZOOKA, MOVE_FLASH_CANNON}
    },
    {
    .lvl = 28,
    .species = SPECIES_EXEGGCUTE,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_EXTRASENSORY, MOVE_LEECH_SEED, MOVE_SLEEP_POWDER}
    },
    {
    .lvl = 30,
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_TOXIC, MOVE_PROTECT, MOVE_SPIKES}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_IRON_DEFENSE, MOVE_BODY_PRESS, MOVE_ROOST, MOVE_DUAL_WINGBEAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 38,
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_STEALTH_ROCK, MOVE_BULLDOZE, MOVE_DRAGON_TAIL, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 37,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_DANCE, MOVE_GRAV_APPLE, MOVE_ACROBATICS, MOVE_LEECH_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 37,
    ...
    .moves = {MOVE_DRAGON_TAIL, MOVE_THUNDER_WAVE, MOVE_THUNDER, MOVE_AQUA_TAIL}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 37,
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_WATERFALL, MOVE_ICE_FANG, MOVE_THUNDER_WAVE, MOVE_SCARY_FACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 44,
    ...
    .moves = {MOVE_SYNCHRONOISE, MOVE_FAKE_OUT, MOVE_SHADOW_CLAW, MOVE_FOCUS_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 42,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SURF, MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_REST, MOVE_ICE_FANG, MOVE_SNORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 14,
    .species = SPECIES_GRAVELER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SELF_DESTRUCT, MOVE_FIRE_PUNCH, MOVE_DEFENSE_CURL, MOVE_ROLLOUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 18,
    ...
    .moves = {MOVE_SHOCK_WAVE, MOVE_SELF_DESTRUCT, MOVE_THUNDER_WAVE, MOVE_NONE}
    },
    {
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCALD, MOVE_CHARGE_BEAM, MOVE_THUNDER_WAVE, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 25,
    .species = SPECIES_RAICHU_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_RISING_VOLTAGE, MOVE_PSYCHIC, MOVE_SPEED_SWAP}
    },
    {
    ...
    .species = SPECIES_TOGEKISS,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_AIR_SLASH, MOVE_DRAINING_KISS, MOVE_FEATHER_DANCE, MOVE_HELPING_HAND}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 30,
    ...
    .moves = {MOVE_RISING_VOLTAGE, MOVE_ACROBATICS, MOVE_STEEL_WING, MOVE_REVERSAL}
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .moves = {MOVE_DIG, MOVE_NIGHT_SLASH, MOVE_HONE_CLAWS, MOVE_SUBSTITUTE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 27,
    ...
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_STRANGE_STEAM, MOVE_SLUDGE_BOMB, MOVE_REST, MOVE_SLEEP_TALK}
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .moves = {MOVE_GRASS_WHISTLE, MOVE_BLIZZARD, MOVE_RAZOR_LEAF, MOVE_INGRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_AURORA_VEIL, MOVE_THUNDER_WAVE, MOVE_AURORA_BEAM, MOVE_ANCIENT_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_STOMPING_TANTRUM, MOVE_IRON_DEFENSE, MOVE_STEALTH_ROCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 26,
    ...
    .heldItem = ITEM_DRAGON_GEM,
    .moves = {MOVE_SYRUP_BOMB, MOVE_DRAGON_PULSE, MOVE_RECOVER, MOVE_DRAGON_TAIL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .moves = {MOVE_ANCIENT_POWER, MOVE_KNOCK_OFF, MOVE_INGRAIN, MOVE_STUN_SPORE}
    }
};
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_MUK,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_TOXIC, MOVE_PROTECT, MOVE_TOXIC_SPIKES, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 28,
    ...
    .moves = {MOVE_THUNDER_WAVE, MOVE_HEX, MOVE_SCALD, MOVE_RISING_VOLTAGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 29,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_X_SCISSOR, MOVE_STICKY_WEB, MOVE_FLY, MOVE_RISING_VOLTAGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 28,
    ...
    .heldItem = ITEM_ELECTRIC_SEED,
    .moves = {MOVE_RISING_VOLTAGE, MOVE_EXTREME_SPEED, MOVE_SNARL, MOVE_AURA_SPHERE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 30,
...
static const struct TrainerMon sParty_Calvin1[] = { //Modified by me
    {
    .iv = 100,
    .lvl = 50,
    .species = SPECIES_METAPOD,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_IRON_DEFENSE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_MUDDY_WATER, MOVE_RAIN_DANCE, MOVE_DRAGON_PULSE, MOVE_ACID_ARMOR}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    ...
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_THUNDERBOLT, MOVE_CHILLING_WATER, MOVE_ACID_SPRAY, MOVE_WEATHER_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(8, 31, 31, 31, 31, 31),
    .lvl = 36,
    .species = SPECIES_JIRACHI,
    .heldItem = ITEM_WEAKNESS_POLICY,
    .moves = {MOVE_LIFE_DEW, MOVE_METEOR_MASH, MOVE_COSMIC_POWER, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 39,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_RECOVER, MOVE_SURF, MOVE_ICE_BEAM, MOVE_LIGHT_SCREEN}
    }
};
...
static const struct TrainerMon sParty_Jared[] = {
    ...
    .moves = {MOVE_TOXIC, MOVE_LEECH_SEED, MOVE_TAILWIND, MOVE_MEGA_DRAIN},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 27,
    .species = SPECIES_SKARMORY,
    .moves = {MOVE_TOXIC, MOVE_PROTECT, MOVE_WING_ATTACK, MOVE_STEEL_WING},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 27,
    .species = SPECIES_CORSOLA,
    .moves = {MOVE_RECOVER, MOVE_ANCIENT_POWER, MOVE_BUBBLE_BEAM, MOVE_PROTECT},
    }
};
...
static const struct TrainerMon sParty_Humberto[] = {
    ...
    .moves = {MOVE_ICY_WIND, MOVE_LEECH_SEED, MOVE_GRASS_KNOT, MOVE_GRASS_WHISTLE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 25,
    .species = SPECIES_FROSMOTH,
    .moves = {MOVE_STRUGGLE_BUG, MOVE_FEATHER_DANCE, MOVE_AURORA_VEIL, MOVE_STUN_SPORE},
    },
};
...
static const struct TrainerMon sParty_Edwardo[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 18, 18, 18, 18, 18),
    .lvl = 28,
    .species = SPECIES_TROPIUS
    },
};
...
static const struct TrainerMon sParty_Colin[] = {
    ...
    .moves = {MOVE_HYPER_BEAM, MOVE_REFRESH},
    },
    {
    .lvl = 100,
...
static const struct TrainerMon sParty_Clarissa[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_AGILITY, MOVE_BATON_PASS, MOVE_SUBSTITUTE, MOVE_DIZZY_PUNCH}
    },
    {
    .lvl = 28,
    .species = SPECIES_AROMATISSE,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_BATON_PASS, MOVE_CALM_MIND, MOVE_DRAINING_KISS, MOVE_SWEET_KISS}
    },
    {
    .lvl = 36,
    .species = SPECIES_MEOWTH,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_MAKE_IT_RAIN, MOVE_NASTY_PLOT, MOVE_SHOCK_WAVE, MOVE_WATER_PULSE}
    }
...
static const struct TrainerMon sParty_Beverly[] = {
    ...
    .lvl = 29,
    .species = SPECIES_CHIMECHO,
    .moves = {MOVE_SYNCHRONOISE, MOVE_EXTRASENSORY, MOVE_YAWN, MOVE_UPROAR}
    }
};
...
static const struct TrainerMon sParty_Imani[] = {
    ...
    .lvl = 23,
    .species = SPECIES_GOLDEEN,
    .moves = {MOVE_BOUNCE, MOVE_DIVE, MOVE_TOXIC, MOVE_SUBSTITUTE}
    },
    {
    .lvl = 26,
    .species = SPECIES_MASQUERAIN,
...
static const struct TrainerMon sParty_GinaAndMia1[] = { //here
    {
    .iv = 100,
    .lvl = 18,
    ...
    .moves = {MOVE_TRICK_ROOM, MOVE_HYPNOSIS, MOVE_THIEF, MOVE_STOMP}
    },
    {
    .iv = 0,
    .lvl = 18,
    .species = SPECIES_INDEEDEE,
    .moves = {MOVE_PSYCHIC_TERRAIN, MOVE_PSYBEAM, MOVE_HELPING_HAND, MOVE_TRI_ATTACK}
    },
    {
    .iv = 100,
    .lvl = 20,
    ...
    .lvl = 24,
    .species = SPECIES_XATU,
    .moves = {MOVE_WISH, MOVE_CALM_MIND, MOVE_SHADOW_BALL, MOVE_STORED_POWER}
    },
...
static const struct TrainerMon sParty_Sylvia[] = {
    ...
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_WILL_O_WISP, MOVE_MEAN_LOOK, MOVE_PROTECT, MOVE_PERISH_SONG}
    },
    {
    .iv = TRAINER_PARTY_IVS(28, 28, 28, 28, 28, 28),
    .lvl = 38,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_ICY_WIND, MOVE_SPIKES, MOVE_TAUNT, MOVE_SHADOW_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(28, 28, 28, 28, 28, 28),
    .lvl = 40,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CHARM, MOVE_REST, MOVE_TAUNT, MOVE_CONFIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(28, 28, 28, 28, 28, 28),
    .lvl = 35,
    ...
    .moves = {MOVE_PERISH_SONG, MOVE_KNOCK_OFF, MOVE_PLAY_ROUGH, MOVE_PURSUIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(28, 28, 28, 28, 28, 28),
    .lvl = 40,
    ...
    .moves = {MOVE_SLUDGE_WAVE, MOVE_MEAN_LOOK, MOVE_SHADOW_BALL, MOVE_PROTECT}
    },
};
...
static const struct TrainerMon sParty_Zach1[] = {
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 24,
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_SUPERPOWER, MOVE_DYNAMIC_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 22,
    .species = SPECIES_SNORLAX,
    .moves = {MOVE_HYPER_BEAM, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 22,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_HEADLONG_RUSH}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 25,
    .species = SPECIES_CHARMELEON,
    .moves = {MOVE_OVERHEAT, MOVE_TAKE_DOWN}
    },
};

static const struct TrainerMon sParty_Zach2[] = {
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 30, 
    .species = SPECIES_MACHOKE,
    ...
    .moves = {MOVE_CLOSE_COMBAT, MOVE_FLARE_BLITZ}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 35,
    .species = SPECIES_COMBUSKEN,
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_FLARE_BLITZ}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 38,
    .species = SPECIES_CHARIZARD,
    .moves = {MOVE_OVERHEAT, MOVE_TAKE_DOWN, MOVE_SUBMISSION}
    }
};
...
static const struct TrainerMon sParty_Johanna[] = {
    ...
    .moves = {MOVE_TAILWIND, MOVE_PRESENT, MOVE_DRILL_PECK, MOVE_FOLLOW_ME}
    },
    {
    .lvl = 33,
    .species = SPECIES_ABSOL,
    .moves = {MOVE_HOWL, MOVE_BITTER_BLADE, MOVE_NIGHT_SLASH, MOVE_DETECT}
    },
    {
    .lvl = 35,
    .species = SPECIES_JUMPLUFF,
    .heldItem = ITEM_WIDE_LENS,
    .moves = {MOVE_WHIRLWIND, MOVE_SLEEP_POWDER, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED}
    },
    {
    .lvl = 37,
    .species = SPECIES_SEAKING,
    .moves = {MOVE_MEGAHORN, MOVE_HORN_DRILL, MOVE_SUPERSONIC, MOVE_FLIP_TURN}
    },
    {
    .lvl = 37,
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_REVERSAL, MOVE_THUNDERBOLT, MOVE_IRON_TAIL, MOVE_ROCK_SLIDE}
    },
    {
    .lvl = 38,
    .species = SPECIES_AUDINO,
    .moves = {MOVE_HEAL_PULSE, MOVE_TRICK_ROOM, MOVE_HYPER_VOICE, MOVE_HELPING_HAND}
    }
};
...
static const struct TrainerMon sParty_Ashley[] = {
    ...
    .moves = {MOVE_BLIZZARD, MOVE_HEADBUTT, MOVE_PROTECT, MOVE_WATER_GUN}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 26,
    .species = SPECIES_NINETALES_ALOLAN,
    .moves = {MOVE_SHEER_COLD, MOVE_CONFUSE_RAY, MOVE_ICY_WIND, MOVE_GRUDGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 26,
    .species = SPECIES_DELIBIRD,
    .moves = {MOVE_PRESENT, MOVE_METRONOME, MOVE_FEATHER_DANCE, MOVE_CHILLING_WATER}
    },
...
static const struct TrainerMon sParty_GruntMagmaHideout9[] = {
    ...
    .lvl = 20,
    .species = SPECIES_DUSKULL,
    .moves = {MOVE_TRICK_ROOM, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY, MOVE_HEX},
    .heldItem = ITEM_EVIOLITE
    },
    {
    .iv = TRAINER_PARTY_IVS(10, 9, 9, 9, 9, 9),
    .lvl = 20,
    .species = SPECIES_SNORLAX,
    .moves = {MOVE_BELLY_DRUM, MOVE_FACADE, MOVE_REST, MOVE_SNORE},
    .heldItem = ITEM_SITRUS_BERRY
    },
    {
    .iv = TRAINER_PARTY_IVS(9, 9, 9, 30, 9, 9),
    .lvl = 22,
    .species = SPECIES_TORKOAL,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_IRON_DEFENSE},
    .heldItem = ITEM_CHARCOAL
    },
    {
    .iv = TRAINER_PARTY_IVS(9, 9, 9, 20, 10, 31),
    .lvl = 22,
    .species = SPECIES_PORYGON,
    .moves = {MOVE_TRICK_ROOM, MOVE_TRI_ATTACK, MOVE_ALLY_SWITCH, MOVE_PSYBEAM},
    .heldItem = ITEM_LUM_BERRY
    },
};
...
static const struct TrainerMon sParty_Devan[] = {
    ...
    .moves = {MOVE_TRICK_ROOM, MOVE_HEAL_PULSE, MOVE_WISH, MOVE_SURF}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 55,
    ...
    .heldItem = ITEM_WEAKNESS_POLICY,
    .moves = {MOVE_HEAT_WAVE, MOVE_POWER_GEM, MOVE_PROTECT, MOVE_SCORCHING_SANDS}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 48,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_ERUPTION, MOVE_EARTH_POWER, MOVE_HEAT_WAVE, MOVE_SOLAR_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 50,
    .species = SPECIES_AMOONGUSS,
    .moves = {MOVE_SPORE, MOVE_RAGE_POWDER, MOVE_POLLEN_PUFF, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 48,
    ...
    .heldItem = ITEM_WIDE_LENS,
    .moves = {MOVE_SLEEP_POWDER, MOVE_SUNNY_DAY, MOVE_SOLAR_BLADE, MOVE_GUILLOTINE}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 50,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SILVER_WIND, MOVE_BUG_BUZZ, MOVE_PSYCHIC, MOVE_SUPERSONIC}
    },
};
...
static const struct TrainerMon sParty_Johnson[] = {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_TAILWIND, MOVE_SKY_DROP, MOVE_WHIRLWIND, MOVE_SUPERPOWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 48,
    .species = SPECIES_HYDREIGON,
    .moves = {MOVE_DRAGON_PULSE, MOVE_SCARY_FACE, MOVE_TRI_ATTACK, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 48,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DISABLE, MOVE_HEAL_PULSE, MOVE_YAWN, MOVE_TRUMP_CARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 46,
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_DRAGON_PULSE, MOVE_THUNDERBOLT, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_MEGAHORN, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_Steven[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SILVER_WIND, MOVE_QUIVER_DANCE, MOVE_PSYCHIC, MOVE_TAILWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_ELECTROWEB, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    ...
    .moves = {MOVE_LEAF_STORM , MOVE_DRAGON_PULSE, MOVE_X_SCISSOR, MOVE_FAKE_OUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 64,
...
static const struct TrainerMon sParty_Andres2[] = {
    ...
    .moves = {MOVE_ROAR_OF_TIME, MOVE_STEALTH_ROCK, MOVE_FLAMETHROWER, MOVE_FLASH_CANNON}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 80,
    ...
    .moves = {MOVE_SPACIAL_REND, MOVE_FOCUS_PUNCH, MOVE_HYDRO_PUMP, MOVE_FIRE_BLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 80,
    ...
    .moves = {MOVE_SHADOW_FORCE, MOVE_DARK_PULSE, MOVE_WILL_O_WISP, MOVE_THUNDERBOLT}
    }
};
