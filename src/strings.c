...
const u8 gtext_TrickRoom[] = _("TRICK ROOM");
const u8 gText_ElectricTerrain[] = _("ELEC TERRAIN");
const u8 gText_GrassyTerrain[] = _("GRASSY TERRAIN");
const u8 gText_MistyTerrain[] = _("MISTY TERRAIN");
const u8 gText_PsychicTerrain[] = _("PSYCH TERRAIN");
const u8 gText_IceCreamCone[] = _("ICE CREAM CONE {CLEAR_TO 0x48}¥800");
const u8 gText_WhippedCream[] = _("WHIPPED CREAM {CLEAR_TO 0x48}¥1200");
const u8 gText_AlphaZero[] = _("AlphaZero");
const u8 gText_QuickThought[] = _("QuickThought");
const u8 gText_Komodo[] = _("Komodo");
const u8 gText_DeepBlue[] = _("DeepBlue");
const u8 gText_Slam[] = _("Slam (80, Normal)");
const u8 gText_FirePunch[] = _("FirePunch (75, Fire)");
const u8 gText_WingAttack[] = _("WingAttack (60, Flying)");
const u8 gText_Bulldoze[] = _("Bulldoze (60, Ground)");
const u8 gText_Volleyball[] = _("Volleyball");
const u8 gText_Checkers[] = _("Checkers");
const u8 gText_BoardGameGo[] = _("Go");
const u8 gText_Chess[] = _("Chess");
const u8 gText_Porygon[] = _("Porygon");
const u8 gText_Jynx[] = _("Jynx");
const u8 gText_Pawniard[] = _("Pawniard");
const u8 gText_Tauros[] = _("Tauros");
